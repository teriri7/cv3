...
图片详细描述，350到500词左右，尽可能描述画面具体客观内容和设计内容细节。
注意：客观内容主要包括主体的长相、动作、朝向画面的角度、姿态、环境、风格体裁、主体年龄、人种、发型、身材、服装造型、五官特征、神情、情绪状态；设计内容主要包括画面构图、景别、观众视角、对焦点（景深）、色调、亮度、饱和度、光照角度、光质、画面风格、情绪、氛围、清晰程度。
输出格式：自然语言描述，语言要流畅、有画面感，不要附加任何解释、说明、标签或非描述内容等冗余开场，仅输出自然语言。我们要做的是内容信息一定要准确。表达方式要有各种各样的、不是特别专业的表达方式，以口语话的方法描述画面内容，不要使用专业的词汇来描述画面。
